...
- `SERVER_PATH = resolve(__dirname, "..", "proxy", "server.mjs")` resolves correctly in both layouts I checked:
  - git checkout: `proxy/server.mjs` exists
